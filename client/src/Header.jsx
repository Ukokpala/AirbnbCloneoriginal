  ...
  return (
    <header className="p-4 flex justify-between">
        ...
        <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300"> 
          <div className="border border-l border-gray-300">Anywhere</div>
          <div className="border border-l border-gray-300">Any week</div>
          <div className="border border-l border-gray-300">Add guests</div>
